<?php
/* Smarty version 5.7.0, created on 2026-02-24 04:56:15
  from 'file:studentForm.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.7.0',
  'unifunc' => 'content_699d2f6f4e00a1_49105110',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '63da1ba6bba86a9db5791a3bfb6c54d58a48c471' => 
    array (
      0 => 'studentForm.tpl',
      1 => 1771475420,
      2 => 'file',
...
function content_699d2f6f4e00a1_49105110 (\Smarty\Template $_smarty_tpl) {
      ...
      <div class="mb-3 row">
        ...
        <div class="col-2">
          ...
          <div class="form-check">
            ...
            <input type="radio" id="checkmale" name="genderselect" value="Male_x" class="form-check-input"

              <?php if ((true && (true && null !== ($_smarty_tpl->getValue('item')['gender'] ?? null))) && $_smarty_tpl->getValue('item')['gender'] == 'Male_x') {?> checked <?php }?> required>
        ...
        <div class="col">
          ...
          <div class="form-check">
            ...
            <input type="radio" id="checkfemale" name="genderselect" value="Female_y" class="form-check-input"

              <?php if ((true && (true && null !== ($_smarty_tpl->getValue('item')['gender'] ?? null))) && $_smarty_tpl->getValue('item')['gender'] == 'Female_y') {?>checked<?php }?> required>
...
" <?php if ($_smarty_tpl->getValue('item')['teacher_id'] === $_smarty_tpl->getValue('teacher')['staffId']) {?>selected<?php }?>>

              <?php echo $_smarty_tpl->getValue('teacher')['teacher_name'];?>
