        ...
        <div class="col-2">
          ...
          <div class="form-check">
            ...
            <input type="radio" id="checkmale" name="genderselect" value="Male_x" class="form-check-input"
              ...
              {if isset($item.gender) && $item.gender == 'Male_x'} checked {/if} required>
        ...
        <div class="col">
          ...
          <div class="form-check">
            ...
            <input type="radio" id="checkfemale" name="genderselect" value="Female_y" class="form-check-input"
              ...
              {if isset($item.gender) && $item.gender=='Female_y'}checked{/if} required>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-8">
          ...
          <select name="teacher_id" id="teacher_id" class="form-select" required>
            ...
            <option value="{$teacher.staffId}" {if $item.teacher_id === $teacher.staffId }selected{/if}>
